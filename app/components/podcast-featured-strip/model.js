...
module.exports = unityComponent({
  async render(ref, data) {
    data._computed.items = data.items.map(({ podcast }) => {
      const { imageUrl, url, title, category, description, customDescription, shouldOverrideDescription, customCategoryLabel, shouldOverrideCategoryLabel } = podcast || {};
