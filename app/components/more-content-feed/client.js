...
const Handlebars = require('handlebars'),
  [ moreContentFeed ] = document.getElementsByClassName('component--more-content-feed'),
  [ loadMore ] = document.getElementsByClassName('section__content-feed-container__loadmore'),
  [ linksSection ] = document.getElementsByClassName('more-content-feed__links'),
  moreContentUrl = moreContentFeed.getAttribute('data-uri').replace(/^.*\.com/, ''),
  itemTemplate = `
    <li>
