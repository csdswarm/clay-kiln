/**
 *
 * Instagram-post component Client.js to handle Instagram Embeds
 *
 */
'use strict';

const embedsLibraryUrl = '//platform.instagram.com/en_US/embeds.js';
...
class InstagramEmbeds {
  ...
  constructor() {
    ...
    /**
     *
     * If Instagram embeds library is loaded, call the embed init/setup function, process(). Else
     * mount the library.
     *
   ...
   *
   * Note that there is no need to call this.process() after because the instagram
  ...
  /**
   *
   * If instagram library is already loaded, call instagram post init/setup code.
   *
   */
  process() {
 ...
 */
module.exports = el => new InstagramEmbeds(el);
