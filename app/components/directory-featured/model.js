...
const genres = [
  ...
  { img: 'Sports-38ff7af4-e9c8-431e-a9b6-5b731cb13f5a', label: 'Sports' },
  { img: 'Country-cdd632d4-31f6-4f28-a13d-9503375ac921', label: 'Country' },
  { ref: 'hiphop', img: 'HipHop-23beb86f-0e55-4718-8f0d-11dc8832ef6a', label: 'Hip Hop' },
  { ref: 'news-talk', img: 'News-b347c36d-2e68-4f51-8255-a2037b2fbe0d', label: 'News' },
  ...
  .map(genre => {
    const safeLabel = genre.label.replace(/\s+/g, '-').toLocaleLowerCase();

    return {css: safeLabel, ref: safeLabel, ...genre};
  });
