...
describe('apSubscription', () => {
  ...
  describe('save', () => {
    it('creates a new record and returns a new id when id is not provided', async () => {
    ...
    it('updates an existing record and return the key updated when id is provided', async () => {
