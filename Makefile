...
dev-bootstrap:
	cd ./app && cat ./first-run/**/*.yml | clay import -k demo -y dev-clay.radio.com
	@echo ""
...
stg-bootstrap:
	cd ./app && cat ./first-run/**/*.yml | clay import -k demo -y stg-clay.radio.com
	@echo ""
