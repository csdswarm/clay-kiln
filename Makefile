up:
	docker-compose up -d nginx redis elasticsearch && while ! curl -sSI -o /dev/null http://localhost:9200/_cat/indices; do sleep 5; done && docker-compose up -d clay && make clay-logs
