...
install-dev:
	cd app && npm i && node ./node_modules/.bin/gulp && npm run build-web-player && cd ../spa && npm i && npm run-script build -- --mode=none

install:
	cd app && npm i && node ./node_modules/.bin/gulp && npm run build-web-player && cd ../spa && npm i && npm run-script build -- --mode=production && npm run-script production-config
