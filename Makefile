...
bootstrap:
	...
	@echo "\r\n\r\n"
	curl -X PUT http://clay.radio.com/_components/two-column-layout/instances/station@published -H 'Authorization: token accesskey' -H 'Content-Type: application/json'
	@echo "\r\n\r\n"
	...
	@echo "\r\n\r\n"
	curl -X PUT http://clay.radio.com/_pages/station@published -H 'Authorization: token accesskey' -H 'Content-Type: application/json'
	@echo "\r\n\r\n"
