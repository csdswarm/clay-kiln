...
(async function () {
  try {
    console.log('Remove ES mappings for stationSyndication.source');
    ...
    console.error('Error occurred while trying to revert ES mappings for stationSyndication.source');
    console.error(e);
  }
})();
