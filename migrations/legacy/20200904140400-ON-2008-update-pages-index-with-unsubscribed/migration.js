...
(async function () {
  try {
    console.log('Adding ES mappings for stationSyndication.unsubscribed to pages index');
    ...
    console.error('Unable to update ES mappings for stationSyndication.unsubscribed to pages index');
    console.error(e);
  }
})();
