...
function makeAfterOpProcedure({ from, to }) {
  ...
  begin
    if (tg_op = 'DELETE') then
      ...
      insert into ${to}_subscriptions(short_desc, station_slug, last_updated_utc, filter, from_station_slug)
      values(new.short_desc, new.station_slug, new.last_updated_utc, new.filter, new.from_station_slug);
