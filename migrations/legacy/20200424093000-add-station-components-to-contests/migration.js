...
const LAYOUTS = [
  { componentUrl: `${hostUrl}/_layouts/two-column-layout/instances/contest`, path: '_layouts.two-column-layout.instances.contest' }
];
...
async function updateLayouts () {
  console.log('Adding station components to contests...\n');
